...
/**
 * Creator for time service entries.
 * 
 * @author DWietoska
 */
@Service("org.powertac.common.TimeService")
@Scope(value = "session", proxyMode = ScopedProxyMode.TARGET_CLASS)
public class TimeServiceReplayerMessageImpl implements ReplayerMessage {
	...
	public Object createObject(long id, String[] args) throws Exception {
		...
		timeService.setCurrentTime(Instant.parse(args[3]));
		return timeService;
	}
