...
public class TariffData
{
  ...
  public TariffData(BrokerModel broker, TariffSpecification spec, double profit, double netKWh,
		long customers, String powerType, String ratesGraph,
		ConcurrentHashMap<CustomerInfo, TariffCustomerStats> tariffCustomerStats) 
  {
	super();
	this.broker = broker;
	this.spec = spec;
	...
	this.tariffCustomerStats = tariffCustomerStats;
   }
