...
public void setTotalMoneyFlowTariffMarket(double totalMoneyFlowTariffMarket) {
	this.totalMoneyFlowTariffMarket = totalMoneyFlowTariffMarket;
}

public void setTotalDistributionTariffMarket(
		double totalDistributionTariffMarket) {
	this.totalDistributionTariffMarket = totalDistributionTariffMarket;
}

public void setTotalSoldEnergyTariffMarket(double totalSoldEnergyTariffMarket) {
	this.totalSoldEnergyTariffMarket = totalSoldEnergyTariffMarket;
}

public void setTotalBoughtEnergyTariffMarket(
		double totalBoughtEnergyTariffMarket) {
	this.totalBoughtEnergyTariffMarket = totalBoughtEnergyTariffMarket;
}

public void setTotalBoughtEnergyWholesaleMarket(
		double totalBoughtEnergyWholesaleMarket) {
	this.totalBoughtEnergyWholesaleMarket = totalBoughtEnergyWholesaleMarket;
}

public void setTotalSoldEnergyWholesaleMarket(
		double totalSoldEnergyWholesaleMarket) {
	this.totalSoldEnergyWholesaleMarket = totalSoldEnergyWholesaleMarket;
}

public void setTotalMoneyFromSellingWholesaleMarket(
		double totalMoneyFromSellingWholesaleMarket) {
	this.totalMoneyFromSellingWholesaleMarket = totalMoneyFromSellingWholesaleMarket;
}

public void setTotalMoneyFromBuyingWholesaleMarket(
		double totalMoneyFromBuyingWholesaleMarket) {
	this.totalMoneyFromBuyingWholesaleMarket = totalMoneyFromBuyingWholesaleMarket;
} 
}
